...
class Project1Test(unittest.TestCase):
    ...
    @timeout(TIMEOUT)
    # Uncomment this line to skip test
    ...
    @timeout(TIMEOUT)
    # Uncomment this line to skip test
    # @unittest.skip("Skip simple minimax test.")
    ...
    @timeout(TIMEOUT)
    # Uncomment this line to skip test
    # @unittest.skip("Skip iterative deepening test.")
    def test_get_move(self):
        ...
        exact_counts = [(8, 8), (32, 10), (160, 39),
                        (603, 35), (1861, 54), (3912, 62)]
